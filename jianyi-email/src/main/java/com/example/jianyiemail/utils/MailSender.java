package com.example.jianyiemail.utils;

import com.example.jianyiemail.baen.MailEntity;
...
public class MailSender {
    ...
    public void send() throws Exception
    {
        ...
        //此处填写SMTP服务器
        props.put("mail.smtp.host",MailConfig.service);
        //设置端口号，QQ邮箱给出了两个端口465/587
        props.put("mail.smtp.port", MailConfig.prot);
        // 设置发送邮箱
        props.put("mail.user",MailConfig.address);
        // 设置发送邮箱的16位STMP口令
        props.put("mail.password", MailConfig.pwd);
        ...
        Authenticator authenticator = new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                // 用户名、密码
                return new PasswordAuthentication(MailConfig.address, MailConfig.pwd);
            }
        };
        // 使用环境属性和授权信息，创建邮件会话
        ...
        // 设置发件人
        String nickName = MimeUtility.encodeText(MailConfig.nickname);
